...
public class ImportarExportar_Gson {
    ...
    public static void GuardarContadores(String Path, String Name){
        ...
        try{
            ...
            Escritor.write(String.valueOf(Equipo.Contador_Equipos)+"\n");
            Escritor.write(String.valueOf(Partido.ContadorPartidos)+"\n");
            Escritor.write(String.valueOf(Torneo.ContadorTorneos)+"\n");
